...
function BookCall() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full bg-black no-scrollbar">
      <style>#root{}</style>
      <NavBar show={true}></NavBar>
      <div className="mt-30 mb-5 flex w-full flex-col items-center text-balance font-quick">
        <p className="flex items-center text-3xl font-bold md:text-7xl">
          Book a call
          <svg
            className="mx-4 hidden size-12 rotate-12 rounded-lg drop-shadow-lg md:block md:size-20"
        ...
        <p className="my-4 text-center text-lg text-balance text-white/65 md:text-2xl">
          ...
          <a
            ...
            className="group inline-block transition-all duration-300 hover:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              ...
              className="lucide lucide-mail mx-2 inline-block size-8 -rotate-12 text-white transition-all duration-300 group-hover:scale-110 group-hover:-rotate-6"
            >
